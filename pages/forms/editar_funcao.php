...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <li class="treeview active">
            ...
            <ul class="treeview-menu">
                <li class="active"><a href="../../pages/forms/editar_funcao.php"><i class="fa fa-circle-o"></i> Funções Cadastradas</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="../../php/control/editar_fun.php">
            <?php include '../../php/control/setdadosfun.php'; ?>
              	<div class="box-body">
                	<div class="form-group">
               		...
               		<div class="form-group">
                    	<label for="ipQnt">Quantidade</label>
                    	<input name="qnt" type="text" class="form-control" id="ipQnt" placeholder="Digite a quantidade para esa função">
                	</div>
                </div>
              <!-- /.box-body -->
  ...
  <script>
      ...
      var qnt = document.getElementById('edqnt').value;
      document.getElementById('ipNome').value = nome;
      document.getElementById('ipQnt').value = qnt;
   </script>
